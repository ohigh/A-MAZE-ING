...
$stmt->bindParam(':id', $userId, PDO::PARAM_STR);
                        if ($stmt->execute() && ($stmt->rowCount() === 1)) {
                            ...
                            echo '<h5>Medlemmet eksistere ikke!</h5>';
                            ...
                            if ($stmt->execute()) {
                                ...
                                $error['brugerfindes'] = 'Medlemmet findes allerede! Vælg en anden e-mail.'; 
                                    ...
                                    if(!sqlQueryPrepared("
                                                            ...
                                                            WHERE profile_id = $id;
                                                            UPDATE `tbl_user` SET `user_email` = :email WHERE fk_user_profile = $id
                                                        ", 
                                                            array(
                                                                ':name' => $fornavn, 
                                                                ':sirname' => $efternavn,
...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <fieldset>
        ...
        <div class="input-field col s12 m6">
            ...
            <input type="email" name="email" value="<?=$resultat->user_email?>" id="email">
        </div>
        <div class="input-field col s12 m6">
        ...
        <div class="input-field col s12 m6">
            <label for="niveau">Gamertype</label>
...
<div class="input-field col s12 m6" >
   <form method="post" action="">
    ...
    <?=@$msg?>
    <fieldset>
        <legend>Ret Brugerrolle</legend>
        <div class="input-field col s12">
            <input type="radio" id="1" name="rolle" value="1" <?=$rolle == 1 ? 'checked="checked"' : ''?>> 
            <label for="1">Administrator</label>
        </div>
        <div class="input-field col s12">
        <br>
			<input type="radio" id="2" name="rolle" value="2" <?=$rolle == 2 ? 'checked="checked"' : ''?>> 
            <label for="2">Moderator</label>
        </div>
		<div class="input-field col s12">
        <br>
            <input type="radio"  id="3" name="rolle" value="3" <?=$rolle == 3 ? 'checked="checked"' : ''?>>
            <label for="3">Medlem</label>
            
        </div>
		<div class="input-field col s12">
        <br>
        <br>
            <button type="submit" name="retRolle" class="btn waves-effect waves-light blue ">Ret</button>
        	
            <button type="submit" name="resetRolle" class="btn waves-effect waves-light orange " value="3">Reset</button>
        </div>
    </fieldset>
</div>
