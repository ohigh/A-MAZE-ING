...
function gameOver() {
    ...
    var userdata = {'point':playerPoint, 'time':0, 'total' :0};
            $.ajax({
            type: "POST",
            url: "../../includes/ajax_result.php",
            data:userdata, 
...
var playerTime;
// function sendToResult(timeLeft) { 
//     var playerTime = timeLeft;
//     return playerTime;
//     }
function gameWon() {
    ...
    score = (seconds * 1) + playerPoint;
    document.querySelector("#display-score").innerHTML = score;
    var userdata = {'point':playerPoint, 'time':seconds, 'total' :score};
            $.ajax({
            type: "POST",
            url: "../../includes/ajax_result.php",
            data:userdata, 
...
// document.querySelector('#all-time').val();
